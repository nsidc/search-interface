...
// TODO
// import * as mapUtility from './spatial_selection_map/utility';
// import * as UtilityFunctions from './utility_functions';

// TODO
// import OpenLayersCustomToolbar from './spatial_selection_map/OpenLayersCustomToolbar';
// import SpatialSelectionLayer from './spatial_selection_map/SpatialSelectionLayer';
// import SpatialSelectionTransformControl from './spatial_selection_map/SpatialSelectionTransformControl';
// import SpatialWmsLayer from './spatial_selection_map/SpatialWmsLayer';
...
//   this.map.on('click', e => this.mediatorTrigger('map:click', e));
// };
...
//   if (this.controls.mousePositionControl !== undefined) {
//     this.map.removeControl(this.controls.mousePositionControl);
//   }
//   // TODO
...
//     if (this.map.projection.proj.srsProjNumber !== mapConstants.PROJECTION_NAMES.GLOBAL) {
//       point.transform(mapConstants.SRID_PROJECTION[this.map.projection.proj.srsProjNumber],
//                       mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL]);
//     }
...
//     vertices = this.transformProjectionBox(geom, this.srid, mapConstants.PROJECTION_NAMES.GLOBAL).getVertices();
...
//   fromEpsg = mapConstants.SRID_PROJECTION[fromSrid];
//   toEpsg = mapConstants.SRID_PROJECTION[toSrid];
...
//   northPole = northPole.transform(mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL], fromEpsg);
//   southPole = southPole.transform(mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL], fromEpsg);
...
//   ]);
//   dateLine = dateLine.transform(mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL], fromEpsg);
...
//   return mapUtility.openLayerRectangleFactory(
...
//   if (newSrid !== mapConstants.PROJECTION_NAMES.GLOBAL) {
//     upperLeftPoint.transform(mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL],
//       mapConstants.SRID_PROJECTION[newSrid]);
//     lowerRightPoint.transform(mapConstants.SRID_PROJECTION[mapConstants.PROJECTION_NAMES.GLOBAL],
//       mapConstants.SRID_PROJECTION[newSrid]);
//   }
...
//   return mapUtility.openLayerRectangleFactory(upperLeftPoint, upperRightPoint, lowerRightPoint, lowerLeftPoint);
// };
...
//   // TODO
//   // this.map.zoomToMaxExtent();
//   if (srid !== mapConstants.PROJECTION_NAMES.GLOBAL) {
//     this.map.zoomIn();
//   }
...
//   // we just created.
//   clickPoly = mapUtility.openLayerRectangleFactory(
...
//   polygon = mapUtility.openLayerRectangleFactory(
...
OpenLayerMap.prototype = _.extend(OpenLayerMap.prototype, mediator_mixin);
