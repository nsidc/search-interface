...
define(function () {
  ...
  return {
    ...
    getArrayFromjQueryArrayTextContents : function (jQueryArray) {
      var results = [],
    ...
    normalizeDate : function (dateString) {
      if (dateString && dateString.length && dateString.length > 0) {
        dateString = this.removeWhitespace(dateString);
    ...
    osGeoBoxToIdentifier: function (osGeoBox) {
    ...
    osGeoBoxFromIdentifier: function (identifier) {
