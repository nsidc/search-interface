...
define(function () {
  var objectFactory,
      ...
      getDefaultOptions, getPreset;

  getDefaultOptions = function (configOptions) {
    var opts = {};
  ...
  getPreset = function (configOptions) {
  ...
  objectFactory = {
    ...
    createInstance: function (type, options) {
      var combinedOptions, defaultOpts, presetOpt, ClassType = getDependencies(type);
      ...
      if (ClassType.configOptions) {
        defaultOpts = getDefaultOptions(ClassType.configOptions);
        presetOpt = getPreset(ClassType.configOptions);
      }
    ...
    setConfig: function (currentConfig) {
