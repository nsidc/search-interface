// import AdeSpatialCoverageTextView from '../../../views/search_criteria/AdeSpatialCoverageTextView';
import GeoBoundingBox from '../../../models/GeoBoundingBox.js';
// Why was this included in define? 'models/SearchParamsModel'

describe.skip('ADE Spatial Coverage Text View ', function () {
