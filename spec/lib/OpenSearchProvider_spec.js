define(['lib/OpenSearchProvider', 'lib/objectFactory', 'lib/FacetsResponse'],
       function (OpenSearchProvider, objectFactory, FacetsResponse) {
  describe('OpenSearchProvider', function () {
    ...
    beforeEach(function () {
      objectFactory.setConfig({ 'FacetsResponse': {Ctor: FacetsResponse, configOptions: {preset: {nameMap: {} } } } });
    });
    ...
    describe('OpenSearch requests', function () {
      ...
      it('should invoke query with specified parameters', function () {
        ...
        expect(queryStub.getCall(0).args[0].parameters).toEqual({
