    ...
    describe('Acadis Search App', function () {
      ...
      describe('NSIDC custom URL routing', function () {
        ...
        it('should route urls that specify page numbers', function () {
          ...
          args = searchParamsSpy.getCall(0).args[0];
      ...
      describe('ACADIS custom URL routing', function () {
        ...
        it('should route urls with facet filters', function () {
          ...
          expect(triggerSpy.getCall(0).args[2]).toEqual({ facet_data_center: [ 'NSIDC' ] });
        });
      ...
      describe('pushing urls into the url history', function () {
        ...
        it('uses the page number from the results collection', function () {
          ...
          expect(app.navigate.callCount).toEqual(1);
          expect(app.navigate.firstCall.args[0]).toContain('pageNumber=7');
        ...
        it('uses the keywords from the results collection', function () {
          ...
          expect(app.navigate.callCount).toEqual(1);
          expect(app.navigate.firstCall.args[0]).toContain('keywords=ice');
        ...
        it('uses the page number, keywords and bbox from the results collection', function () {
          ...
          expect(app.navigate.callCount).toEqual(1);
          expect(app.navigate.firstCall.args[0]).toContain('pageNumber=5');
          expect(app.navigate.firstCall.args[0]).toContain('keywords=ice');
          expect(app.navigate.firstCall.args[0]).toContain('osGeoBbox=N:90,S:-80,E:120,W:-150');
        ...
        it('does not put unused parameters into the URL string', function () {
          ...
          expect(app.navigate.callCount).toEqual(1);
          expect(app.navigate.firstCall.args[0]).not.toContain('keywords');
          expect(app.navigate.firstCall.args[0]).not.toContain('endDate');
        });
      });
