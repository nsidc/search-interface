define(
    ['lib/objectFactory', 'models/SearchParamsModel', 'collections/SearchResultsCollection'],
    function (objectFactory, SearchParamsModel, SearchResultsCollection) {
      ...
      describe('The objectFactory object', function () {
        it('should get the initial dependency mappings from the config object', function () {
          ...
          // Assert
          expect(objectFactory.register.callCount).toEqual(1);
