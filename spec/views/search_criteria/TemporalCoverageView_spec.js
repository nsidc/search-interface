define(['collections/SearchResultsCollection',
        ...
        function (SearchResultsCollection, TemporalCoverageView) {
  describe('Temporal Coverage View', function () {
    ...
    describe('datepicker date range', function () {
      ...
      it('first renders the datepicker without any date range options', function () {
        expect(setupDatepicker.getCall(0).args[0].startDate).toBe(null);
        expect(setupDatepicker.getCall(0).args[0].endDate).toBe(null);
      });
      ...
      it('updates the datepicker options when the EDB date range request is complete', function () {
        ...
        expect(setupDatepicker.getCall(0).args[0].startDate).toBe(testStartDate);
        expect(setupDatepicker.getCall(0).args[0].endDate).toBe(testEndDate);
      });
      ...
      it('updates the datepicker with today for the end date if the EDB end date is not in the future', function () {
        ...
        expect(setupDatepicker.getCall(0).args[0].endDate).toBe(today);
      });
